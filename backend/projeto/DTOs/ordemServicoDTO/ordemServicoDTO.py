...
class OrdemServicoDTO:
    ...
    def build(self):
        return {
            ...
            "carro_id": int(self.form_data.get("carro_id")) if self.form_data.get("carro_id") and self.form_data.get("carro_id").strip() else None,
            ...
            "observacoes_importantes": self.form_data.get("observacoes_importantes").strip().capitalize(),
